                        ...
                        @foreach ($zones as $zone)
                            <tr data-entry-id="{{ $zone->id }}">
                                ...
                                <td>
                                     ...
                                     <input class="elsSetting" zone-name="{{$zone->name}}"   zone-id="{{$zone->id}}"  type="checkbox" data-onstyle="success" data-offstyle="secondary" {{ $zone->els === 1 ? "checked" : "" }} data-toggle="toggle" data-on="Enabled" data-off=" Disabled">
                                </td>
                                <td>
