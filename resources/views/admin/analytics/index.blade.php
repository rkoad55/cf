                    ...
                    <div class="card card-tabs">
                        <div class="card-header">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item"><a class="active nav-link " href="#requests" data-toggle="tab">Requests</a></li>
                                <li class="nav-item"><a class="nav-link" href="#bandwidth" data-toggle="tab">Bandwidth</a></li>
                                <li class="nav-item"><a class="nav-link" href="#visitors" data-toggle="tab">Visitors</a></li>
                                <li class="nav-item"><a class="nav-link" href="#threats" data-toggle="tab">Threats</a></li>
                                <li class="nav-item"><a class="nav-link" href="#http_statuses" data-toggle="tab">Status</a></li>
                            </ul>
                        </div>
...
<div class="card card-analytics">
    ...
    <div class="card-body">
         <div class="row no-gutters">
            <div class="col-sm-12 col-md-4"><strong>Content Type Breakdown</strong><br>
        <?php echo $timestamp; ?></div></div>
...
<div class="card card-default">
    ...
    <div class="card-body">
        <div class="row no-gutters">
            <div class="col-sm-12 col-md-4"><strong>Types of Threats Mitigated</strong><br>
        <?php echo $timestamp; ?></div></div>
...
<script src="{{ url('js/chartkick.js') }}"></script>
    ...
    // request chart data
    Highcharts.chart('request-graph', {
        chart: {
        ...
        xAxis: {
            ...
            foreach ($requests as $key => $value) {
              // code...
              $requestsPeriod[]=$value['period'];
            }
            echo json_encode($requestsPeriod);
...
borderWidth: 0,
  shared: true,
        ...
        series: [{
            ...
            foreach ($requests as $key => $value) {
              // code...
              $requestsCached[]=$value['cached'];
            }
            echo json_encode($requestsCached);
        ...
        },
        {
            ...
            foreach ($requests as $key => $value) {
              // code...
              $requestsUncached[]=$value['uncached'];
            }
            echo json_encode($requestsUncached);
    ...
    Highcharts.chart('bandwidth-graph', {
        chart: {
            marginLeft: 40, // Keep all charts left aligned
            spacingTop: 20,
            spacingBottom: 20
        ...
        xAxis: {
            ...
            foreach ($bandwidth as $key => $value) {
              // code...
              $bandwidthPeriod[]=$value['period'];
            }
            echo json_encode($bandwidthPeriod);
...
borderWidth: 0,
  shared: true,
        ...
        series: [{
            ...
            foreach ($bandwidth as $key => $value) {
              // code...
              $bandwidthCached[]=$value['cached'];
            }
            echo json_encode($bandwidthCached);
        ...
        },
        {
            ...
            foreach ($bandwidth as $key => $value) {
              // code...
              $bandwidthUncached[]=$value['uncached'];
            }
            echo json_encode($bandwidthUncached);
    ...
    // unique visitors
    // 
    Highcharts.chart('visitors-graph', {
    credits: {
            enabled: false
        },
    ...
    xAxis: {
            ...
            foreach ($uniques as $key => $value) {
              // code...
              $uniqueVisits[]=$value['period'];
            }
            echo json_encode($uniqueVisits);
    ...
    Highcharts.chart('statuses-graph', {
    credits: {
            enabled: false
        },
    title: {
    ...
    xAxis: {
            ...
            categories: <?php
            echo json_encode($status_codes['period']);
            ?>,
            labels: {
            formatter: function () {
                return '<a href="' + this.value + '">' +
    ...
    series: [
    <?php foreach ($status_codes as $key => $value) { 
        if($key !== 'period'){
        ?>
        {
        name: '<?php echo $key ?>',
    ...
    Highcharts.chart('threats-graph', {
    credits: {
            enabled: false
        },
    title: {
    ...
    xAxis: {
            ...
            categories: <?php
            echo json_encode($threats['period']);
            ?>,
            labels: {
            formatter: function () {
                return '<a href="' + this.value + '">' +
    ...
    series: [
    <?php foreach ($threats as $key => $value) { 
        if($key !== 'period'){
        ?>
        {
        name: '<?php echo $key ?>',
    ...
    //     lineColors: ['rgba(31, 119, 180,0.7)','rgba(174, 199, 232,0.7)','rgba(31, 119, 180,0.7)'],
    //
    //     resize: true,
    //     parseTime: false,
    //     pointSize: "1px",
    //     pointStrokeColors: "rgb(31, 119, 180)",
...
$(target).find('.graphbox').css('height','230px');
      ...
      $(target).find('.graphbox').css('height','auto');
       ...
       $(target).find('svg').attr('width','100%');
