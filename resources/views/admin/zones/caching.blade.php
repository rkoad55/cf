...
<div class="content">
 ...
 <input type="hidden" name="csrftoken" value="{{csrf_token()}}" >
  ...
  <div class="card card-2col cacheClearDiv">
      <div class="card-body">
...
Purge Cache    
  ...
  <p class="text-info">This setting was last changed 2 days ago</p>
          ...
          <div class="col-sm-12 col-md-3 right flex-column">
          
               
               <button swalTitle="Purge All Cache?" swalText="Purging your cache may slow your website temporarily." zoneName="{{ $zone->name }}" action="purgeCacheAll" class="btn btn-info btn-sm customActions">Purge Everything</button>
...
Separate tags(s) with commas, or list one per line " zoneName="{{ $zone->name }}" action="purgeFiles" extra="files" class="btn btn-info btn-sm customActions">Purge Files</button>
                ...
                <button disabled="disabled" class="btn btn-danger btn-sm customActions">Purge Tags (Not Available for this domain)</button>

 @else
                <button  swalTitle="Purge Cache By Tags" swalText="You can purge up to 30 tags at a time.

Separate tags(s) with commas, or list one per line" zoneName="{{ $zone->name }}" action="purgeTags" extra="tags" class="btn btn-info btn-sm customActions">Purge Tags</button>
