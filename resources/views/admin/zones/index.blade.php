                    ...
                    @if(count($users) > 0)
                        ...
                        @if(($type=="sp" AND $zone->cfaccount_id==0) OR ($type=="cf" AND $zone->cfaccount_id!=0))
                            <tr data-entry-id="{{ $zone->id }}">
                                ...
                                <td><a href="{{ route('admin.users.zones',[$zone->user->id]) }}" class="btn btn-sm btn-info">{{ $zone->user->name }} ({{ $zone->user->email }})</a>

                                    <a href="{{ route('admin.zones.ownership',[$zone->id]) }}" class="btn btn-sm btn-primary">Change Ownership</a>
