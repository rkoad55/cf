            ...
            <div style="display: none;" class="row">
             ...
             <div  class="row">
                    ...
                    @foreach($abilities as $ability)
                        <input style="min-width: 400px;" value="{{ $ability->name }}" name="abilities[]"  type="checkbox" data-onstyle="success" data-offstyle="secondary" checked data-toggle="toggle" data-on="{{ ucwords(str_replace("_", " ", $ability->name)) }}" data-off="{{ ucwords(str_replace("_", " ", $ability->name)) }}">
