      ...
      <div class="row">
        <div class="col">
          <div class="content-title">
            <h1>DNS</h1>
            <h2>Manage your Domain Name System (DNS) settings</h2>
          </div>
...
<div class="before-panel">
 ...
 @if($records->count())
    <div class="card card-2col">
      ...
      <a href="#" class="btn btn-primary" id="add_dns" data-toggle="modal" data-target=".bs-example-modal-lg" > Add New record</a>
      ...
      <input type="hidden" name="csrftoken" value="{{csrf_token()}}" >
        ...
        <table style="display: none;" class="table table-bordered table-striped table-condensed">
            ...
            <table class="table table-bordered table-striped table-condensed dns-table">
                    ...
                    @if($record->ttl=="1") Automatic TTL
                       @elseif($record->ttl=="120") 2 minutes
                        ...
                        @endif
                                ...
                                <td class="text-center">@if($record->proxiable)
                                    <input class="dnsProxy"   record-id="{{$record->id}}"   id="{{$record->id}}"  type="checkbox" {{ $record->proxied === 1 ? "checked" : "" }} "><label for="{{$record->id}}" ></label> 
                                    @endif

                                  </td>
                                <td class="text-center">
                                    <a href="#" record-id="{{$record->id}}" class="btn btn-outline-danger btn-xs deleteDNS">
